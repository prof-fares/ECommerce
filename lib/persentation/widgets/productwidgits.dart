...
import 'package:ecommerce/persentation/screens/productdetails.dart';
                                ...
                                wishlistbloc.add(Addwishlist(
                                    wishlistmodel:
                                        (wishlistbloc.state as WishListGetted)
                                            .wishlist,
                                    token: sl<LogInRepository>().token,
                                    productid: product.sId));
                              }
                              else{
                                wishlistbloc.add(Removewishlist(token: sl<LogInRepository>().token, productid: product.sId,wishlistmodel:  (wishlistbloc.state as WishListGetted)
                                            .wishlist,));
                              }
                            },
